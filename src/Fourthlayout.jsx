...
const Fourthlayout = ({ image, name, price, inCart, toggleCart }) => {
  return (
    <>
      <div className="bg-white rounded-xl shadow-lg overflow-hidden lg:w-60 w-40 hover:scale-105 hover:shadow-xl transition-transform duration-300 ">
        {image && (
          <img
            src={image}
            alt={name}
            className="lg:w-full w-40 lg:h-80 h-40 m-2 object-cover lg:p-3" // fixed height and cover
          />
        )}
